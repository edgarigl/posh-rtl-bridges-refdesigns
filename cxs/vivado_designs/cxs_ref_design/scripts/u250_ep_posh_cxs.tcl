...
################################################################
# This is a generated script based on design: u250_ep_posh_cxs
#
...
# source u250_ep_posh_cxs_script.tcl
...
set design_name u250_ep_posh_cxs
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:ip:cxs_bridge_top:1.00\
...
# Hierarchical cell: Gpio_intr_out_cxs_1
proc create_hier_cell_Gpio_intr_out_cxs_1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_Gpio_intr_out_cxs_1() - Empty argument(s)!"}
     return
  }
...
# Hierarchical cell: Gpio_intr_out_cxs_0
proc create_hier_cell_Gpio_intr_out_cxs_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_Gpio_intr_out_cxs_0() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_Xilinx_PCIe_Tunnel { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net CXS_Bridge_1_irq_out_0 [get_bd_pins intr_1] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net CXS_Bridge_1_irq_out_1 [get_bd_pins intr_0] [get_bd_pins xlconcat_0/In0]
...
proc create_hier_cell_GPIOs { parentCell nameHier } {
  ...
  # Create instance: Gpio_intr_out_cxs_0
  create_hier_cell_Gpio_intr_out_cxs_0 $hier_obj Gpio_intr_out_cxs_0

  # Create instance: Gpio_intr_out_cxs_1
  create_hier_cell_Gpio_intr_out_cxs_1 $hier_obj Gpio_intr_out_cxs_1

  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI1_2 [get_bd_intf_pins S_AXI3] [get_bd_intf_pins Gpio_intr_in/S_AXI1]
  connect_bd_intf_net -intf_net S_AXI2_1 [get_bd_intf_pins S_AXI4] [get_bd_intf_pins Gpio_intr_out_cxs_1/S_AXI]
  connect_bd_intf_net -intf_net S_AXI3_1 [get_bd_intf_pins S_AXI5] [get_bd_intf_pins Gpio_intr_out_cxs_1/S_AXI1]
  connect_bd_intf_net -intf_net S_AXI4_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins Gpio_intr_out_cxs_0/S_AXI]
  connect_bd_intf_net -intf_net S_AXI5_1 [get_bd_intf_pins S_AXI1] [get_bd_intf_pins Gpio_intr_out_cxs_0/S_AXI1]
  connect_bd_intf_net -intf_net S_AXI_2 [get_bd_intf_pins S_AXI2] [get_bd_intf_pins Gpio_intr_in/S_AXI]

  # Create port connections
  connect_bd_net -net CXS_Bridges_Dout [get_bd_pins s_axi_aresetn] [get_bd_pins Gpio_intr_in/s_axi_aresetn] [get_bd_pins Gpio_intr_out_cxs_0/s_axi_aresetn] [get_bd_pins Gpio_intr_out_cxs_1/s_axi_aresetn]
  connect_bd_net -net CXS_Bridges_h2c_intr_out [get_bd_pins Din1] [get_bd_pins Gpio_intr_out_cxs_1/Din]
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins Gpio_intr_out_cxs_0/Din]
  connect_bd_net -net M00_ACLK_1 [get_bd_pins s_axi_aclk] [get_bd_pins Gpio_intr_in/s_axi_aclk] [get_bd_pins Gpio_intr_out_cxs_0/s_axi_aclk] [get_bd_pins Gpio_intr_out_cxs_1/s_axi_aclk]
...
# Hierarchical cell: CXS_Bridges
proc create_hier_cell_CXS_Bridges { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_CXS_Bridges() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir O -from 127 -to 0 cxs_b_h2c_intr_out
  create_bd_pin -dir I cxs_b_irq_ack
  create_bd_pin -dir O cxs_b_irq_out
  create_bd_pin -dir I -from 63 -to 0 cxs_f_c2h_intr_in
  create_bd_pin -dir O -from 127 -to 0 cxs_f_h2c_intr_out
  create_bd_pin -dir I cxs_f_irq_ack
  create_bd_pin -dir O cxs_f_irq_out
  create_bd_pin -dir I -type rst resetn

  # Create instance: cxs_bridge_top_0, and set properties
  set cxs_bridge_top_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:cxs_bridge_top:1.00 cxs_bridge_top_0 ]

  # Create instance: cxs_bridge_top_1, and set properties
  set cxs_bridge_top_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:cxs_bridge_top:1.00 cxs_bridge_top_1 ]
  set_property -dict [ list \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI1_1 [get_bd_intf_pins S_AXI1] [get_bd_intf_pins cxs_bridge_top_1/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins cxs_bridge_top_0/S_AXI]
  connect_bd_intf_net -intf_net cxs_bridge_top_0_cxs_t [get_bd_intf_pins cxs_bridge_top_0/cxs_t] [get_bd_intf_pins cxs_bridge_top_1/cxs_r]
  connect_bd_intf_net -intf_net cxs_bridge_top_1_cxs_t [get_bd_intf_pins cxs_bridge_top_0/cxs_r] [get_bd_intf_pins cxs_bridge_top_1/cxs_t]

  # Create port connections
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins cxs_bridge_top_0/clk] [get_bd_pins cxs_bridge_top_1/clk]
  connect_bd_net -net cxs_b_irq_ack_1 [get_bd_pins cxs_b_irq_ack] [get_bd_pins cxs_bridge_top_0/irq_ack]
  connect_bd_net -net cxs_bridge_top_0_h2c_gpio_out [get_bd_pins cxs_bridge_top_0/h2c_gpio_out] [get_bd_pins cxs_bridge_top_1/c2h_gpio_in]
  connect_bd_net -net cxs_bridge_top_0_h2c_intr_out [get_bd_pins cxs_b_h2c_intr_out] [get_bd_pins cxs_bridge_top_0/h2c_intr_out]
  connect_bd_net -net cxs_bridge_top_0_irq_out [get_bd_pins cxs_b_irq_out] [get_bd_pins cxs_bridge_top_0/irq_out]
  connect_bd_net -net cxs_bridge_top_1_h2c_gpio_out [get_bd_pins cxs_bridge_top_0/c2h_gpio_in] [get_bd_pins cxs_bridge_top_1/h2c_gpio_out]
  connect_bd_net -net cxs_bridge_top_1_h2c_intr_out [get_bd_pins cxs_f_h2c_intr_out] [get_bd_pins cxs_bridge_top_1/h2c_intr_out]
  connect_bd_net -net cxs_bridge_top_1_irq_out [get_bd_pins cxs_f_irq_out] [get_bd_pins cxs_bridge_top_1/irq_out]
  connect_bd_net -net cxs_bridge_top_1_usr_resetn [get_bd_pins cxs_bridge_top_1/usr_resetn] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net cxs_f_c2h_intr_in_1 [get_bd_pins cxs_f_c2h_intr_in] [get_bd_pins cxs_bridge_top_0/c2h_intr_in] [get_bd_pins cxs_bridge_top_1/c2h_intr_in]
  connect_bd_net -net cxs_f_irq_ack_1 [get_bd_pins cxs_f_irq_ack] [get_bd_pins cxs_bridge_top_1/irq_ack]
  connect_bd_net -net resetn_1 [get_bd_pins resetn] [get_bd_pins cxs_bridge_top_0/resetn] [get_bd_pins cxs_bridge_top_1/resetn]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: CXS_Bridges
  create_hier_cell_CXS_Bridges [current_bd_instance .] CXS_Bridges
  ...
  connect_bd_intf_net -intf_net S_AXI1_1 [get_bd_intf_pins CXS_Bridges/S_AXI1] [get_bd_intf_pins Interconnect_fabric/M01_AXI]
  ...
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins CXS_Bridges/S_AXI] [get_bd_intf_pins Interconnect_fabric/M00_AXI]
  ...
  # Create port connections
  connect_bd_net -net CXS_Bridge_1_irq_out_0 [get_bd_pins CXS_Bridges/cxs_b_irq_out] [get_bd_pins Xilinx_PCIe_Tunnel/intr_1]
  connect_bd_net -net CXS_Bridges_Dout [get_bd_pins CXS_Bridges/Dout] [get_bd_pins GPIOs/s_axi_aresetn] [get_bd_pins Interconnect_fabric/M01_ARESETN]
  connect_bd_net -net CXS_Bridges_h2c_intr_out [get_bd_pins CXS_Bridges/cxs_f_h2c_intr_out] [get_bd_pins GPIOs/Din1]
  connect_bd_net -net CXS_Bridges_irq_out [get_bd_pins CXS_Bridges/cxs_f_irq_out] [get_bd_pins Xilinx_PCIe_Tunnel/intr_0]
  connect_bd_net -net Din_1 [get_bd_pins CXS_Bridges/cxs_b_h2c_intr_out] [get_bd_pins GPIOs/Din]
  connect_bd_net -net M00_ACLK_1 [get_bd_pins CXS_Bridges/clk] [get_bd_pins GPIOs/s_axi_aclk] [get_bd_pins Interconnect_fabric/M00_ACLK] [get_bd_pins Xilinx_PCIe_Tunnel/axi_aclk]
  connect_bd_net -net Xilinx_PCIe_Tunnel_axi_aresetn [get_bd_pins CXS_Bridges/resetn] [get_bd_pins Interconnect_fabric/M07_ARESETN] [get_bd_pins Xilinx_PCIe_Tunnel/axi_aresetn]
  connect_bd_net -net c2h_intr_in_1 [get_bd_pins CXS_Bridges/cxs_f_c2h_intr_in] [get_bd_pins GPIOs/dout]
  connect_bd_net -net pcie_perstn_1 [get_bd_ports pcie_perstn] [get_bd_pins Xilinx_PCIe_Tunnel/pcie_perstn]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins CXS_Bridges/cxs_f_irq_ack] [get_bd_pins Xilinx_PCIe_Tunnel/intr_ack_0]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins CXS_Bridges/cxs_b_irq_ack] [get_bd_pins Xilinx_PCIe_Tunnel/intr_ack_1]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x20002000 [get_bd_addr_spaces Xilinx_PCIe_Tunnel/xdma_0/M_AXI_B] [get_bd_addr_segs GPIOs/Gpio_intr_out_cxs_1/axi_gpio_2/S_AXI/Reg] SEG_axi_gpio_2_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x20004000 [get_bd_addr_spaces Xilinx_PCIe_Tunnel/xdma_0/M_AXI_B] [get_bd_addr_segs GPIOs/Gpio_intr_out_cxs_0/axi_gpio_2/S_AXI/Reg] SEG_axi_gpio_2_Reg1
  create_bd_addr_seg -range 0x00001000 -offset 0x20003000 [get_bd_addr_spaces Xilinx_PCIe_Tunnel/xdma_0/M_AXI_B] [get_bd_addr_segs GPIOs/Gpio_intr_out_cxs_1/axi_gpio_3/S_AXI/Reg] SEG_axi_gpio_3_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x20005000 [get_bd_addr_spaces Xilinx_PCIe_Tunnel/xdma_0/M_AXI_B] [get_bd_addr_segs GPIOs/Gpio_intr_out_cxs_0/axi_gpio_3/S_AXI/Reg] SEG_axi_gpio_3_Reg1
  create_bd_addr_seg -range 0x00020000 -offset 0xC0000000 [get_bd_addr_spaces Xilinx_PCIe_Tunnel/xdma_0/M_AXI_B] [get_bd_addr_segs CXS_Bridges/cxs_bridge_top_0/S_AXI/Mem] SEG_cxs_bridge_top_0_reg0
  create_bd_addr_seg -range 0x00020000 -offset 0xC0020000 [get_bd_addr_spaces Xilinx_PCIe_Tunnel/xdma_0/M_AXI_B] [get_bd_addr_segs CXS_Bridges/cxs_bridge_top_1/S_AXI/Mem] SEG_cxs_bridge_top_1_reg0
